            ...
            user: {
             ...
             menuGroups: [
                ...
                },
                {
                    ...
                    isOpen: true,
                    items: [
                        { name: 'Repair Requests', icon: 'repair', link: '../Repair/create.php' },
                        { name: 'Technicians', icon: 'technicians', link: '#' }
                    ]
                },
                {
                    title: 'Users',
                    isOpen: true,
                    items: [
                        { name: 'Users', icon: 'users', link: '../Users/index.php' },
                        { name: 'Owners', icon: 'owners', link: '#' }
                    ]
                },
                {
                    title: 'System',
    ...
    methods: {
        ...
        getIcon(iconName) {
            const icons = {
                ...
                categories: 'M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z',
