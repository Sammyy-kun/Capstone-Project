const app = Vue.createApp({
    data(){
        return{
            ...
            //Here Also need dapat naka connect tong heading sa database para macount kung ilan
            summaryGroups:[
                {
                    icon:'users',
                    bgColor:'bg-blue-100',
                ...
                },
                {
                    ...
                    subHeading:'Total Business Owners',
                    heading:'24'
                },
                {
                    icon:'business',
                    ...
                    subHeading:'Pending Business Requests',
                    heading:'45'
                },
                {
                    icon:'reject',
                    ...
                    subHeading:'Rejected Businesses',
                    heading:'55'
                },
            ],
