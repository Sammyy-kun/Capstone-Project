                ...
                <p class="text-center mb-8 text-sm sm:text-base text-gray-600">Fill in your credentials to access your account</p>
                    <form id="loginForm">
                        <div class="mb-6">
                            ...
                            <input   type="text" id="email" name="email" v-model="username" class="w-full h-12 rounded-md border-2 border-gray-200 focus:outline-emerald-500 px-4 py-3">
                        </div>
                        <div class="mb-6">
                            <label class="block mb-3 font-semibold">Password</label>
                            <input type="password" id="password" name="password" v-model="password" required class="w-full h-12 rounded-md border-2 border-gray-200 focus:outline-emerald-500 px-4 py-3">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mb-6">
                                <button type="submit" id="submit" @click.prevent="submit" class="w-full h-12 font-semibold bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition duration-300">Login</button>
                            </div>
                    </form>
