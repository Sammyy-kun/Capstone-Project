            ...
            <div v-for="product in sortedProducts" :key="product.id" class="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div class="p-5 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto flex items-center justify-between gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            <button :disabled="product.stock <= 0" :class="product.stock <= 0 ? 'bg-gray-200 cursor-not-allowed' : 'bg-white hover:bg-gray-50 border-2 border-emerald-500'" class="p-2 rounded-lg transition-colors duration-200">
